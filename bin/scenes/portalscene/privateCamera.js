...
function Initialize()
{
    ...
    {
        // Remove temp freelookcamera HAX
        scene.RemoveEntity(2147483649);
        ...
        var camera = me.GetOrCreateComponent("EC_Camera", 2, false);
        //var inputmapper = me.GetOrCreateComponent("EC_InputMapper", 2, false);
        var placeable = me.GetOrCreateComponent("EC_Placeable", 2, false);
        var oldTransform = placeable.transform;
        oldTransform.pos = new float3(0, 6.29, -13.54);
        oldTransform.rot = new float3(-23.50,-178.80,0);
        placeable.transform = oldTransform;
        //<attribute value="0,6.29,-13.54,-22.80,-178.80,0,1,1,1" name="Transform"/>
...
function DisconnectApplication()
{
    if (_g.connected)
    {
        // Disconnect frame updates and enabled inputmapper
